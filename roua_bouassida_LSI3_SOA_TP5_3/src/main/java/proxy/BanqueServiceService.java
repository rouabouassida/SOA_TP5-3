 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8083/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8083/?wsdl");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://service/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "BanqueWSPort"), BanqueWS.class, features);
    }
