...
public class ObjectFactory {
    ...
    /**
     * Create an instance of {@link ConvertEuroToDinar }
     * 
     * @return
     *     the new instance of {@link ConvertEuroToDinar }
     */
    public ConvertEuroToDinar createConvertEuroToDinar() {
        return new ConvertEuroToDinar();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ConvertEuroToDinar }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ConvertEuroToDinar }{@code >}
     */
    @XmlElementDecl(namespace = "http://service/", name = "convertEuroToDinar")
    public JAXBElement<ConvertEuroToDinar> createConvertEuroToDinar(ConvertEuroToDinar value) {
        return new JAXBElement<>(_ConvertEuroToDinar_QNAME, ConvertEuroToDinar.class, null, value);
    }
